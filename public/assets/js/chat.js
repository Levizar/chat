(() => {
    ...
    // Add a listenner to trigger the send message function
    ...
    // Send a message when a user join the room
    ...
    // Send a message when a user leave the room and update the userList
